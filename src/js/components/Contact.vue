<template>
  <form @submit.prevent="submit">
    ...
    <button type="submit" class="button is-primary is-rounded is-inverted is-outlined" v-if="!sent">Enviar mensaje </button>
    <button class="button is-loading is-rounded" v-if="sending"></button>
    <button type="submit" class="button is-primary is-rounded is-inverted is-outlined" v-if="sent" disabled>Enviar mensaje </button>
  ...
  export default{
    ...
    methods:{
      ...
      send(){
          ...
          const self = this;
          axios.post('https://aluminiotrebol.com/contacto/enviar', {
