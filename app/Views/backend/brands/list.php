    ...
    <div class="card">
        <div class="card-filter">
            ...
            <div class="field has-addons">
                <p class="control">
                    <a class="button is-primary c-white" href="<?php echo base_url('admin/brands/new'); ?>">
                      ...
                      <td class="has-text-centered">
                          <div class="field is-grouped action">
                              <p class="control">
                                        ...
                                        <form
                                            action="<?php echo base_url('admin/brands/edit/'. $brand['id_brand']) ?>"
                                            method="post">
                              ...
                              <p class="control">
                                  <a class="button is-rounded is-text action-delete modal-button" data-target="modal-<?=$brand['id_brand']?>">
                                      <span class="icon">
        ...
        <?php foreach($brands as $brand):?>
        <div id="modal-<?=$brand['id_brand']?>" class="modal modal-fx-3dRotateFromBottom">
            <div class="modal-background"></div>
            <div class="modal-content">
                <div class="modal-card">
                    <header class="modal-card-head">
                        <p class="modal-card-title">Eliminar Marca</p>

                    </header>
                    <section class="modal-card-body">
                        <p class="is-size-4">¿Deseas borrar definitivamente La marca
                            <?=$brand['brand_name']?>?</p>
                    </section>
                    <footer class="modal-card-foot">
                        <form
                            action="<?php echo base_url('admin/brands/delete/' . $brand['id_brand']); ?>"
                            method="post">
                            <btn
                                link=""
