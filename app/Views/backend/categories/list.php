    ...
    <div class="card">
        <div class="card-filter">
            ...
            <div class="field has-addons">
                <p class="control">
                    <a class="button is-primary c-white" href="<?php echo base_url('admin/categories/new'); ?>">
                      ...
                      <td class="has-text-centered">
                          <div class="field is-grouped action">
                              <p class="control">
                                        ...
                                        <form
                                            action="<?php echo base_url('admin/categories/edit/'. $category['id_category']) ?>"
                                            method="post">
                              ...
                              <p class="control">
                                  <a class="button is-rounded is-text action-delete modal-button" data-target="modal-<?=$category['id_category']?>">
                                      <span class="icon">
        ...
        <?php foreach($categories as $category):?>
        <div id="modal-<?=$category['id_category']?>" class="modal modal-fx-3dRotateFromBottom">
            <div class="modal-background"></div>
            <div class="modal-content">
                <div class="modal-card">
                    <header class="modal-card-head">
                        <p class="modal-card-title">Eliminar categoría</p>

                    </header>
                    <section class="modal-card-body">
                        <p class="is-size-4">¿Deseas borrar definitivamente La categoría
                            <?=$category['category_name']?>?</p>
                    </section>
                    <footer class="modal-card-foot">
                        <form
                            action="<?php echo base_url('admin/categories/delete/' . $category['id_category']); ?>"
                            method="post">
                            <btn
                                link=""
