                                                        ...
                                                        <div class="select">
                                                            <select name="category_id" id="category_id">
                                                                <option
                                                                    ...
                                                                    :selected="(category.id_category === c_category) ? 'selected' : ''"
                                                                    >
                                                        ...
                                                        <div class="select">
                                                            <select name="brand_id" id="brand_id">
                                                                <option
                                                                    ...
                                                                    :selected="(brand.id_brand === c_brand) ? 'selected' : ''"
                                                                    >
                                                                    {{brand.brand_name}}
                                                                    </option>
                                                            </select>
